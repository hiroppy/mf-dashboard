...
- 「今月の食費は？」などカテゴリ合計の質問には、対象月のカテゴリ合計だけを取得し、summary、categoryBreakdownを提示してください。個別取引は取得しないでください。ユーザーがそのカテゴリの明細、取引、詳細を明示的に求めた場合だけ対象取引を検索し、transactionListを追加してください。
